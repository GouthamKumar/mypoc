...
- (void)setSKSTableViewDelegate:(id<SKSTableViewDelegate>)SKSTableViewDelegate
{
    ...
    [self setSeparatorColor:[UIColor grayColor]];//colorWithRed:236.0/255.0 green:236.0/255.0 blue:236.0/255.0 alpha:1.0]];
...
//    NSMutableArray *indexPaths = [NSMutableArray arrayWithObject:indexPath];
    ...
    {
//        [self collapseCurrentlyExpandedIndexPath];
        NSLog(@"%d",cell.isExpandable);
...
- (void)collapseCurrentlyExpandedIndexPath
{
    NSMutableArray *totalExpandedIndexPaths = [NSMutableArray array];
    NSMutableArray *totalExpandableIndexPaths = [NSMutableArray array];
...
-(void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    ...
    NSString *strUser = [[NSUserDefaults standardUserDefaults] valueForKey:@"scrolling"];
    
    if (strUser == (id)[NSNull null] || strUser.length == 0) {
        strUser = @"";
    }
    
    if ([strUser isEqualToString:@"scrollno"]) {
